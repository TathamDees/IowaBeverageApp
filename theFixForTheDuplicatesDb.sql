...
SELECT *
FROM iowa_liquor_sales
INTO OUTFILE 'C:\wamp64\tmp\fixedDatabase.csvinvoice_number'
FIELDS ENCLOSED BY '"' 
TERMINATED BY ';' 
ESCAPED BY '"' 
LINES TERMINATED BY '\r\n';

#other 'C:\wamp64\tmp\fixedDatabase.csv'
#other 'C:\Users\Tatham\Vandy\Databases\Project2\Project2Code\fixedDatabase.csv'
